...
further real defect (`ds-textarea` had no hover styling at all, in either
theme — since fixed). Every visual defect the passes found is now fixed;
what's left in DEFECTS.md is behavioural, tooling, or the scrollbar-gutter
scrim strip.
